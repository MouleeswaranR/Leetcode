class Solution {
    ...
    public int earliestFinishTime(int[] landStartTime, int[] landDuration, int[] waterStartTime, int[] waterDuration) {
        int firstLand=findFinishTime(landStartTime,landDuration,waterStartTime,waterDuration);
        int firstWater=findFinishTime(waterStartTime,waterDuration,landStartTime,landDuration);
